# FOREVER Landing Page — Master Build Plan (Final)
Version: 2.0 (Merged)
...
## 0.1) Decision Governance & Change Control
...
## 1.3) Traffic Source Assumptions
...
## 4.3) Sales Escalation & Human Handoff
...
### Step 8.4 — Asset & Media Strategy (NEW)
**Action:** Define:
- Video hosting (YouTube vs. heavy hosting)
- Image optimization pipeline (WebP/AVIF)
**Output:** `media_strategy.md`

---

## 9) Development & Integrations (Day 10–18)

### Step 9.0 — Pipeline & Reliability (NEW)
**Action:** Setup on Day 1 of Dev:
...
## 11) QA, Security & Compliance (Day 16–20)

- Claim compliance
- UX QA
- Privacy, ToS, cookie consent
- WCAG 2.1 AA basics
- **Security Check:** Headers (CSP), rate limiting, npm audit
...
## 12) Localization & Market Variants
...
## 15) Failure Criteria & Pivot Rules
