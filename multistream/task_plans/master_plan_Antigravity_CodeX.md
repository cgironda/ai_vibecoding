...
1. All core flows match `master_specification.md`.
2. Feature ownership and failure behavior match `feature_backend_mapping.md`.
3. Schema matches `teaching_first_database_schema.md`.
